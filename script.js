...
function wyswietlSamochody(lista) {
    ...
    if (lista.length === 0) {
        kontener.innerHTML = '<p class="brak-wynikow">Nie znaleziono samochodów.</p>'
    }
}
...
loginZatwierdzBtn.addEventListener("click", () => {
    ...
    if (login === "" || !loginPattern.test(login)) {
        loginBlad.innerHTML = "Login musi zawierać od 3 do 15 znaków i zawierać tylko litery i cyfry."
    } else {
